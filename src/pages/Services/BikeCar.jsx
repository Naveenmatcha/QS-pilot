...
const SUBS_BIKE = [
  { id: "b1", label: "Bike Wash", price: "₹99" },
  { id: "b2", label: "Oil Change", price: "₹199" },
  { id: "b3", label: "Car Minor Service", price: "₹499" },
];
  ...
  return (
    <div className="p-4 pb-28">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <h2 className="text-lg font-bold">Bike & Car Service</h2>
        <div />
      </div>
      ...
      >
        ...
        <div className="relative z-10 h-full p-4 flex flex-col justify-between text-white">
          <div>
            <h3 className="text-xl font-bold">Bike & Car Service</h3>
            <p className="text-sm opacity-90">
              Quick wash, servicing & light maintenance
            </p>
          </div>
      ...
      <div className="bg-white p-4 rounded-2xl shadow mb-4">
        <p className="text-sm text-gray-600">
          Quick wash, oil change and light maintenance by trusted mechanics.
        </p>
      </div>
